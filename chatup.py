...
if __name__ == '__main__':
	...
	eventlet.wsgi.server(eventlet.listen(('kite.cs.illinois.edu', 5353)), app)
	eventlet.wsgi.server(eventlet.wrap_ssl(eventlet.listen(('kite.cs.illinois.edu', 5353)), certfile='cert.crt',keyfile='private.key',server_side=True), app)
